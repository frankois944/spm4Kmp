package io.frankois944.spmForKmp.plugin.tasks

import io.frankois944.spmForKmp.plugin.CompileTarget
import io.frankois944.spmForKmp.plugin.definition.SwiftDependency
import io.frankois944.spmForKmp.plugin.operations.getXcodeDevPath
import io.frankois944.spmForKmp.plugin.operations.getXcodeVersion
...
internal abstract class GenerateCInteropDefinitionTask
    ...
    constructor(
        ...
        init {
            ...
            group = "io.frankois944.spmForKmp.plugin.tasks"
        }
