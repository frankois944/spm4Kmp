package io.frankois944.spmForKmp.plugin.fixture
...
org.gradle.caching=true
    ...
    private fun Subproject.Builder.setupGradleConfig(extension: TestConfiguration) {
        withBuildScript {
            imports = Imports.of("io.frankois944.spmForKmp.plugin.definition.SwiftDependency")
            plugins(
                Plugin.of("org.jetbrains.kotlin.multiplatform", "2.1.0"),
                Plugin(
                    "io.frankois944.spmForKmp.plugin",
