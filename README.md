...
- Plugin Usages (search for [fr.frankois944.spmForKmp](https://github.com/cortinico/kotlin-gradle-plugin-template/search?q=fr.frankois944.spmForKmp&unscoped_q=fr.frankois944.spmForKmp) in the repo and replace it with your ID).
